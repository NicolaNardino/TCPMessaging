...
public final class RestfulServletContextListener implements ServletContextListener{
	...
	public void contextInitialized(final ServletContextEvent event) {
		...
		event.getServletContext().setAttribute(Utility.MongoDBManagerServletContextAttributeName, new MongoDBManager(new MongoDBConnection(sc.getInitParameter("mongodb_host"), 
